...
echo "========== 全部构建完成 =========="
echo "输出目录：release/"
echo "  完整版（Intel）：DramaStudio-x.x.x-mac-x64.dmg"
echo "  完整版（ARM）  ：DramaStudio-x.x.x-mac-arm64.dmg"
echo "  纯净版（Intel）：DramaStudio-Lite-x.x.x-mac-x64.dmg"
echo "  纯净版（ARM）  ：DramaStudio-Lite-x.x.x-mac-arm64.dmg"
echo ""

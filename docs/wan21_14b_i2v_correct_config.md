...
width=           {{width}}     ← 480p:832, 720p:1280
height:          {{height}}    ← 默认480
...
| wan2.1 fp8 + 人物图 | 832×480 | 81 | 20 | 450s | 420KB | 3K-42K |
| wan2.1 fp8 + 人物图 | 1280×720 | 81 | 20 | ~1420s | 838KB | 5K-89K |
| wan2.1 fp8 + 人物图 | 1280×720 | 41 | 20 | 578s | 513KB | 验证中 |
| wan2.1 fp8 + 明星肖像 | 832×480 | 81 | 20 | 449s | 491KB | 验证中(质量差) |

**预计性能**：
- 832×480/41帧/20步 ≈ 220-250s（RTX 4080 SUPER 32G）
- 832×480/81帧/20步 ≈ 450s ≈ 7.5分钟（每步20秒）
- 1280×720/41帧/20步 ≈ 578s ≈ 9.6分钟（每步26秒）
- 1280×720/81帧/20步 ≈ 1420s ≈ 24分钟（每步71秒）

**帧率说明**：wan2.1官方训练帧率fps=16。81帧@16fps=5秒视频，41帧@16fps≈2.56秒。

**质量结论**：
- 41帧质量明显优于81帧（77K色/std>70 vs 3K-42K色/std<60）
- 720p(1280×720)分辨率比480p慢10倍，但画质无显著改善（模型variant=i2v_480，720p非训练分辨率）
- 明星肖像首帧不匹配输入图→输入图质量太低(103KB)是根因，非模型问题
- prompt含大动作(转头)会导致人物隐形/变形，应写微动作(微风轻拂头发)

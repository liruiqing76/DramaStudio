#!/usr/bin/env python3
"""wan2.1 14B I2V: 480p (832x480) 81帧@16fps=5秒视频, 明星肖像"""
...
workflow = {
    ...
    "3": {
        ...
        "inputs": {
            ...
            "positive_prompt": "A woman with subtle gentle expression, soft breeze lightly moving hair strands, warm golden sunlight filtering through, serene and cinematic atmosphere, high quality detail",
    ...
    "12": {
        ...
        "inputs": {
            "filename_prefix": "wan21_celeb_5s",
            "video": ["11", 0],
            "format": "auto",
            "codec": "auto"
        }

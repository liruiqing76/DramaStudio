#!/usr/bin/env python3
"""
wan2.1 14B I2V + Lightx2v 4-step LoRA加速 v3
修正：模型名/节点名/参数名全部按API返回的真实值
"""
...
workflow = {
    # 1. Load wan2.1 fp8 model (注意：没有_KJ后缀)
    "1": {
        "class_type": "WanVideoModelLoader",
        "inputs": {
            "model": "wan2.1_i2v_480p_720p_14B_fp8_e4m3fn.safetensors",
            "base_precision": "bf16",
    ...
    # 5. Load CLIP Vision (ComfyUI内置节点)
    "5": {
    ...
    # 7. CLIP Vision encode (WanVideoWrapper节点)
    "7": {
    ...
    # 8. Select LoRA by name (Lightx2v 4-step for wan2.1)
    "8": {
...
print("=== wan2.1 14B I2V: Lightx2v 4-step LoRA v3 ===")
print(f"Nodes: {len(workflow)} | Steps=4 | CFG=1.0 | LoRA=lightx2v_4step")
print("修正: 模型名fp8_e4m3fn(无_KJ), CLIPVisionLoader, LoadWanVideoT5TextEncoder")

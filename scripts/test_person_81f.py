#!/usr/bin/env python3
"""
wan2.1 14B I2V: 81帧(3.2s@16fps) 人物图 + 官方参数
基于test_official_41f.py的成功配置
"""
...
workflow = {
    ...
    "3": {
        ...
        "inputs": {
            ...
            "positive_prompt": "A young woman stands gracefully in a sunlit garden, she slowly turns her head and smiles warmly, her hair gently sways in the breeze, sunlight plays across her face, cinematic lighting, smooth natural motion",
    ...
    "12": {
        ...
        "inputs": {
            "filename_prefix": "wan21_person_81f",
            "video": ["11", 0],
            "format": "auto",
            "codec": "auto"
        }

#!/usr/bin/env python3
"""wan2.1 14B I2V + Lightx2v 4-step v5 - 修正VAE precision参数"""
...
print("=== wan2.1 14B I2V: Lightx2v 4-step v5 ===")
print("修正: VAE=Wan2_1_VAE_bf16+precision, T5→TextEncode, CLIPVisionLoader")

#!/usr/bin/env python3
"""
wan2.1 14B I2V: 720p (1280x720) 41帧 + 微动作提示词
"""
...
workflow = {
    ...
    "3": {
        ...
        "inputs": {
            ...
            "positive_prompt": "A woman standing in a garden, subtle breeze gently moving her hair, soft warm sunlight, serene atmosphere, cinematic quality",
    ...
    "12": {
        ...
        "inputs": {
            "filename_prefix": "wan21_720p_41f",
            "video": ["11", 0],
            "format": "auto",
            "codec": "auto"
        }

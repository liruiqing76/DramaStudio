#!/usr/bin/env python3
"""
wan2.1 14B I2V test with DIFFERENT image: ig_27164208.png
Using confirmed success params
"""
...
workflow = {
    ...
    "3": {
        ...
        "inputs": {
            ...
            "positive_prompt": "A young woman in traditional Chinese dress walks gracefully through a moonlit garden, cherry blossoms falling softly around her, cinematic lighting, gentle wind",

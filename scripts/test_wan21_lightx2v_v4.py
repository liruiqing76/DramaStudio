#!/usr/bin/env python3
"""wan2.1 14B I2V + Lightx2v 4-step LoRA v4 - 修正T5连接"""
...
print("=== wan2.1 14B I2V: Lightx2v 4-step LoRA v4 ===")
print(f"Nodes: {len(workflow)} | Steps=4 | CFG=1.0 | T5 connected to TextEncode")
